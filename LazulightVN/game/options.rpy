...
## Defines layers for renpy
define config.layers = [ "master", "transient", "foreground", "screens", "overlay" ]
...
define gui.about.management = _p("""
...
Finana Route Assistant Writer: {p}
The Holy Wooomy with 69 Nuggets of Toasted Squidies
""")

define gui.about.writing.question = _p("""
??? Route Writer:{p}
Akatsukin
""")

define gui.about.writing.lazulight = _p("""
Lazulight Route Writer:{p}
Akatsukin
""")

define gui.about.writing2 = _p("""
Proofreading Lead:{p}
JFND
...
Sound Effects:{p}
freesound.org under the CC0 license{p}
Tophrii (Keyboard sounds)

Diamond City Lights (Song):{p}
Vocals: Lazulight{p}
Composer: Mafumafu

Diamond City Lights (Fan Instrumental):{p}
...
define gui.about.qa = _p("""
{u}{size=+10}QA Team:{/size}{/u}
