...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Load") action ShowMenu('load') hover_sound audio.choose activate_sound audio.confirm
    ...
    vbox:
        ...
        if main_menu:
            ...
            if len(persistent.endings) == 3:
                textbutton _("Start") action Start() at menu_start_shake
        ...
        if main_menu and len(persistent.endings) != 0:
...
screen about():
    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        vbox:
            ...
            text "[gui.about.writing1!t]\n"
            if "lazulight" not in persistent.endings:
                text "[gui.about.writing.question!t]\n"
            else:
                text "[gui.about.writing.lazulight!t]\n"
            text "[gui.about.writing2!t]\n"
    ...
    hbox:
        ...
        vbox:
            ...
            imagebutton auto "gui/button/settings_reset_%s.png" action [
                ...
                Preference("music volume", config.default_music_volume),
                ...
                window:
                    ...
                    if h.rollback_identifier:
                        imagebutton:
                            ...
                            action Confirm("Return to this point?", [With(Fade(0.5, 0.0, 0.5)), RollbackToIdentifier(h.rollback_identifier)])
                            hover_sound audio.choose
                            activate_sound audio.confirm
...
style confirm_frame:
    background Frame("gui/prompt_box.png", gui.confirm_frame_borders, tile=gui.frame_tile)
...
screen name_prompt():
    ...
    frame:
        ...
        null height 5
        text "The gender of the protagonist is not decided in this game," style "confirm_name_prompt_subtext" xalign .5
        text "so you are free to imagine them as you like" style "confirm_name_prompt_subtext" xalign .5
...
style confirm_name_prompt_text is confirm_prompt_text
